...
export default function ResourcesPage() {
  return <main className="resources-page">
    <header className="resource-header"><a href="/"><img src="/eff-university-dove-crest.png" alt="EFF University dove crest" /><span><b>EFF UNIVERSITY</b><small>COLLEGE RESOURCE CENTER</small></span></a><nav><a href="/">Campus Home</a><a href="/community">Student Login</a><a href="https://portal.estherfundsfoundation.org/" target="_blank" rel="noreferrer">Get EFF Help</a></nav></header>
